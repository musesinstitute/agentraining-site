...
(()=>{
 ...
 function install(){
   ...
   if(params.get('onboarding')==='1' && !document.querySelector('.relationship-onboarding')){
     ...
     card.innerHTML='<h3>'+(isManager?managerTitle:learnerTitle)+'</h3><p>'+(isManager?managerBody:learnerBody)+'</p><p class="privacy">'+t('With your knowledge, useful information from this conversation can help build your growth profile so your AI partner can support you more personally over time. You can skip anything you do not want to share.','在您知情的情况下，对未来有帮助的信息可以逐步形成您的成长档案，让 AI 以后更了解您、更有针对性地帮助您。任何不想回答的问题都可以跳过。')+'</p><button class="begin" type="button">'+t(isManager?'Start our conversation':'Start with my introduction',isManager?'开始我们的交流':'从介绍我自己开始')+'</button>';
